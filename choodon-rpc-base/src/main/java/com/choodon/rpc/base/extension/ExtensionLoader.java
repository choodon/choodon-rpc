...
//			if (spi.scope() == Scope.SINGLETON) {
//				if (args.length > 0) {
//					return getSingletonInstance(name, args);
//				} else {
//					return getSingletonInstance(name);
//				}
//			} else {
...
//	}
    ...
    @SuppressWarnings("rawtypes")
    private T getSingletonInstance(String name, Object... args) throws InstantiationException, IllegalAccessException,
    ...
    private static <T> void failThrows(Class<T> type, String msg, Throwable cause) {
        throw new RPCFrameworkException(type.getName() + ": " + msg, cause);
    }
    ...
    private void parseUrl(Class<T> type, URL url, List<String> classNames) throws ServiceConfigurationError {
        ...
        try {
            ...
            reader = new BufferedReader(new InputStreamReader(inputStream, RPCConstants.DEFAULT_CHARACTER));
    ...
    private static <T> void failThrows(Class<T> type, String msg) {
        throw new RPCFrameworkException(type.getName() + ": " + msg);
    }
